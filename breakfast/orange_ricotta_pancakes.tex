...
\begin{recipe}
	...
	\pre{The ricotta in this recipe only adds to the texture, but the citrus adds a fresh taste to the pancakes. ``For a different twist, switch the cirtus ingredient to lime or lemon juice.''}
