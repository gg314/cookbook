...
\begin{recipe}
	...
	\pre{NOTE: Delete this recipe, but add the bacon to the other recipe. This simple beer cheese soup recipe can be made with a variety of cheeses and any kind of beer from Guinness to Bud Light! Caramelized onions in the broth add great depth of flavor, along with crispy bacon and green onions to garnish!}
